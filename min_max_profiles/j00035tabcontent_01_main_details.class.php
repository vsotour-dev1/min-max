 ...
 *
 * @version Jomres 9.9.19 rusty 9.11.1
 *
...
class j00035tabcontent_01_main_details
{
    public function __construct($componentArgs)
    {
		...
		//property days  rusty code
        $output['HDAYS'] = jr_gettext('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_DAYS', 'Days', false);
        $output['DAYS'] = $MiniComponents->specificEvent('06000', 'show_property_days', array('output_now' => false, 'property_uid' => $property_uid));
