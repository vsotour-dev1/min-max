...
class j05020dobooking
{
    public function __construct($componentArgs = array())
    {
		...
		$epoint = get_showtime('ePointFilepath');	
        ...
        require_once JPATH_BASE.'/jomres/remote_plugins/min_max_profiles/libraries/dobooking.php';
	...
	public function get_epoint(){
		
	$ePointFilepath = get_showtime('ePointFilepath');	
		return $ePointFilepath;
	}
